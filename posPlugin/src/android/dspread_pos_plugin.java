...
public class dspread_pos_plugin extends CordovaPlugin {
	...
	class MyPosListener extends CQPOSService {
      ...
      callbackKeepResult(PluginResult.Status.OK, true, "getQposInfo", content);
        ...
        callbackKeepResult(PluginResult.Status.ERROR, true, "doTrade", "no_card_detected");
        ...
        callbackKeepResult(PluginResult.Status.ERROR, true, "doTrade", "card_inserted/NOT_ICC");
			} else if (arg0 == DoTradeResult.BAD_SWIPE) {
				TRACE.d("bad_swipe");
        callbackKeepResult(PluginResult.Status.ERROR, true, "doTrade", "bad_swipe");
        ...
        callbackKeepResult(PluginResult.Status.ERROR, true, "doTrade", "NFC_transaction_declined");
			}else if (arg0 == DoTradeResult.NO_RESPONSE) {
				TRACE.d("card_no_response");
        callbackKeepResult(PluginResult.Status.ERROR, true, "doTrade", "NFC_card_no_response");
			}
		}
      ...
      callbackKeepResult(PluginResult.Status.ERROR, true, "scanQPos2Mode", "scan_finished");
		}
